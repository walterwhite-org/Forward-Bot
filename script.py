...
► ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ [ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ](https://t.me/HC_Founder/8)</b>"""
  
  ABOUT_TXT = """<b>
╔════❰ ғᴏʀᴡᴀʀᴅ ʙᴏᴛ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣
║┣⪼📃ʙᴏᴛ : [ ᴛʏʟᴇʀ ᴅᴜʀɴᴅᴇɴ ](https://t.me/tyler_forwardbot)
║┣⪼👦Cʀᴇᴀᴛᴏʀ : [ ʜᴇɪsᴇɴʙᴇʀɢ 👑](https://t.me/HC_Founder)
║┣⪼🤖Uᴘᴅᴀᴛᴇ : [ ʜᴏᴅʏᴄʟᴏᴜᴅ ](https://t.me/HodyCloud)
